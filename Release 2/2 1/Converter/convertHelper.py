...
def createASCIIString(text):
	...
	delSpecialChar(text, htmlCode=True)
...
def getListOfPickles():
	...
	"""
	pfadZuPickles = os.getcwd() + "/pickleFiles"
...
# 	
# def convertToHTMLEntities(unicodeString, htmlCode=True):
...
# 	if htmlCode == False:
# 		unicodeString = cgi.escape(unicodeString, quote=True)
# 	asciiString = unicodeString.encode('ascii', 'xmlcharrefreplace')
# 	del(unicodeString)
# 	
# 	return asciiString
